...
class Vishal
{
    ...
    public:
        ...
        virtual void display()=0; //Pure Virtual class and abstrac class
                                  //Error throw beacuse of pure virtual class use
};
...
class VishalVideo: public Vishal
{
    ...
    public:
        ...
        void display()
        {
            cout<<"This video tital is "<<tital<<endl;      //Not use display in Vishalvideo(dirivedclass) Error throw beacuse of pure virtual class use
